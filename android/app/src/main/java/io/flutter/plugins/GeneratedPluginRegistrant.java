...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new app.gebeta.gebetagl.MapLibreMapsPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin gebeta_gl, app.gebeta.gebetagl.MapLibreMapsPlugin", e);
    }
    try {
